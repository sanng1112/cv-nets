...
@LOSS_REGISTRY.register(name="dice", type="segmentation")
class DiceLoss(BaseSegmentationCriteria):
    def __init__(self, opts: argparse.Namespace, *args, **kwargs) -> None:
        ...
        self.smooth = getattr(opts, "loss.segmentation.dice.smooth", 1.0)
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        group.add_argument(
            "--loss.segmentation.dice.smooth",
            type=float,
            default=1.0,
            help="Smoothing factor for Dice Loss. Defaults to 1.0.",
        )
        return parser    
