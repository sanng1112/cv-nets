...
@LOSS_REGISTRY.register(name="l2", type="regression")
class L2Loss(BaseRegressionCriteria):
    def __init__(self, opts: argparse.Namespace, *args, **kwargs) -> None:
        ...
        self.reduction = getattr(opts, "loss.regression.l2.reduction", "mean")
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        group.add_argument(
            "--loss.regression.l2.reduction",
            type=str,
            default="mean",
            choices=["mean", "sum", "none"],
            help="Reduction method for L2 loss.",
        )
        return parser
